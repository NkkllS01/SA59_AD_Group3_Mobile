...
class ReportSightingFragment : Fragment(), OnMapReadyCallback {
    ...
    private fun handleSubmit() {
        ...
        val uploader = SpacesUploader(requireContext())
        val fileName = "sightings/${System.currentTimeMillis()}.jpg"

        uploader.uploadFile(file,fileName){imageUrl->
            if(imageUrl!=null){
                val sighting = Sightings(
                    ...
                    details = details,
                    imageUrl = imageUrl, // Need upload-to-cloud implementations
                    latitude = latitude,
                    longitude = longitude,
